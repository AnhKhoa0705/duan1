    ...
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="row text-center">
                ...
                <h5 class="p-4" style="font-weight: 700;">Tạo tài khoản của bạn</h5>
            </div>
            <div class="mb-2">
                <label for="username"><i 
                  class="fa fa-user"></i>Tên</label>
            ...
            <div class="mb-2 mt-2">
                <label for="password"><i 
                  class="fa fa-lock"></i>Mật khẩu</label>
            ...
            <div class="mb-2 mt-3">
                ...
                bg-success" style="font-weight: 600;">Tạo tài khoản</button>
            </div>
            <div class="mb-2 mt-4">
                <p class="text-center" style="font-weight: 600; 
                color: navy;">Đã có tài khoản<a href="./login.php"
                        style="text-decoration: none;">Đăng Nhập</a></p>
            </div>
        </form>
    </div>
    <script>
