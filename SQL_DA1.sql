...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  `Status` varchar(50) DEFAULT NULL,
  CONSTRAINT `fk_image_product` FOREIGN KEY (`Image_ID`) REFERENCES `product`(`ID`)
);
...
CREATE TABLE IF NOT EXISTS `product_rate` (
  ...
  CONSTRAINT `fk_product_rate_user` FOREIGN KEY (`User_ID`) REFERENCES `users`(`ID`)
);
...
CREATE TABLE IF NOT EXISTS `variant` (
  ...
  CONSTRAINT `fk_variant_option` FOREIGN KEY (`Option_ID`) REFERENCES `variant_option`(`ID`)
);
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  CONSTRAINT `fk_news_new_category` FOREIGN KEY (`New_Cat_ID`) REFERENCES `new_category`(`ID`),
  CONSTRAINT `fk_news_image` FOREIGN KEY (`Image_ID`) REFERENCES `image`(`ID`)
);
...
CREATE TABLE IF NOT EXISTS `order_detail` (
  ...
  CONSTRAINT `fk_order_detail_variant` FOREIGN KEY (`Variant_ID`) REFERENCES `variant`(`ID`)
);

INSERT IGNORE INTO `category` (`ID`, `Name`, `Image`, `Status`) VALUES
...
INSERT IGNORE INTO `coupons` (`ID`, `Code`, `Discount`, `Expiry_Date`, `Status`) VALUES
...
INSERT IGNORE INTO `news` (`ID`, `New_Cat_ID`, `Image_ID`, `Name`, `Create_Date`, `Content`, `Status`, `Likes`) VALUES
...
INSERT IGNORE INTO `new_category` (`ID`, `Name`, `Status`) VALUES
...
INSERT IGNORE INTO `product` (`ID`, `Category_ID`, `Image_ID`, `Name`, `Discount`, `Views`, `Description`, `Detail`, `Status`) VALUES
...
INSERT IGNORE INTO `image` (`ID`, `Name`, `Image_URL`, `Status`) VALUES
...
INSERT IGNORE INTO `product_rate` (`ID`, `Product_ID`, `User_ID`, `Date`, `Status`, `Rating`, `Review`) VALUES
...
INSERT IGNORE INTO `users` (`ID`, `Username`, `Password`, `Name`, `Phone`, `Email`, `Role`, `Status`) VALUES
...
INSERT IGNORE INTO `variant_option` (`id`, `size`, `color`, `price`, `quantity`) VALUES
(1, 'S', 'Đỏ', 200000.00, 10),
(2, 'M', 'Đỏ', 210000.00, 15),
(3, 'L', 'Đỏ', 220000.00, 20),
...
INSERT IGNORE INTO `variant` (`ID`, `Product_ID`, `option_ID`) VALUES
(51, 1, 1),
(52, 1, 2),
(53, 1, 3),
(54, 1, 4),
...
INSERT IGNORE INTO `orders` (`ID`, `User_ID`, `Coupon_ID`, `Name`, `Phone`, `Address`, `Order_Date`, `Payment_Method`, `Total_Amount`, `Delivery_Date`, `Status`) VALUES
...
INSERT IGNORE INTO `order_detail` (`ID`, `Order_ID`, `Variant_ID`, `Price`, `Quantity`) VALUES
(1, 1, 1, 250000.00, 1),
(2, 2, 3, 350000.00, 1),
(3, 3, 4, 450000.00, 1),
(4, 4, 5, 400000.00, 1),
